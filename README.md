...
Para facilitar o uso e a contribuição, criamos uma documentação detalhada e acessível em português do Brasil.

**➡️ [Acesse a documentação completa aqui](./documentacao/README.md)**

Dentro da pasta `documentacao`, você encontrará:

-   **[🚀 Guia de Instalação](./documentacao/INSTALACAO.md)**: Passo a passo para configurar o projeto.
-   **[🔌 Guia de Conexão](./documentacao/CONEXAO_WHATSAPP.md)**: Como conectar seu número de WhatsApp.
-   **[📖 Referência de Endpoints](./documentacao/ENDPOINTS.md)**: Detalhes técnicos de cada endpoint da API.
-   **[💡 Exemplos Práticos](./documentacao/EXEMPLOS.md)**: Receitas de código para cenários comuns.
-   **[⚙️ Guia de Configuração](./documentacao/CONFIGURACAO.md)**: Referência para todas as variáveis de ambiente.
-   **[🏗️ Visão da Arquitetura](./documentacao/ARQUITETURA.md)**: Explicação sobre os serviços e o fluxo de dados.
-   **[🤯 Guia de Troubleshooting](./documentacao/TROUBLESHOOTING.md)**: Soluções para os problemas mais comuns.
-   **[🤝 Guia de Contribuição](./documentacao/CONTRIBUINDO.md)**: Como você pode contribuir para o projeto.
-   **[📄 Especificação OpenAPI](./documentacao/openapi.yaml)**: Para integração com ferramentas de API.
